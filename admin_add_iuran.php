        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Data Iuran</h1>
                        </div><!-- /.col -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" style="font-size: 18px;">
                            <div class="col-11">
                                <form method="post" action="admin_add_iuran.php" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <input type="hidden" class="form-control" name="warga_id" id="warga_id" value="<?php echo $id; ?>" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label d-block">Jenis Iuran</label>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_iuran" value="1" />
                                            <label class="form-check-label" for="inlineRadio1">Uang Kas</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_iuran" value="2" />
                                            <label class="form-check-label" for="inlineRadio2">Uang Sampah</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_iuran" value="3" />
                                            <label class="form-check-label" for="inlineRadio2">Sumbangan</label>
                                        </div>
                                    </div>
                                    <div class="mb-3">
