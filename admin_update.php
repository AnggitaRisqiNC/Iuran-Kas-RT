...
if (isset($_POST['submit'])) {
    ...
    $sql .= "jenis_kelamin = '{$jenis_kelamin}', no_hp = '{$no_hp}', alamat = '{$alamat}', no_rumah = '{$no_rumah}'";
    $sql .= "WHERE id = '{$id}'";
                            ...
                            <div class="col-11">
                                <form method="post" action="admin_update.php" enctype="multipart/form-data">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="nik" class="form-control" name="nik" value="<?php echo $data['nik']; ?>" />
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="no_rumah" id="no_rumah" value="<?php echo $data['no_rumah']; ?>" />
                                    </div>
                                    <div class="submit d-inline">
                                        <input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
                                        <button type="submit" class="btn btn-success fw-medium" name="submit"><i class="far fa-edit"></i> Update</button>
                                    </div>
